export const en = {
  ...
  analysisSummaryPrompt: (targetLang: string) => 
    `Analyze the **entire video** (beginning, middle, and end) and generate an **extremely concise** summary (3-5 sentences) that captures only the core ideas and conclusions.\n\nRequirements:\n1. **Cover the entire video**: Include key points from beginning, middle, and end\n2. **Extremely concise**: Keep only the essential points, remove all redundant information\n3. **Highlight priorities**: Most important insights, conclusions, or actionable takeaways\n4. **Timestamps**: Use [HH:MM:SS] or [MM:SS] format for key moments\n5. **Markdown format**, language: ${targetLang}\n\n**Forbidden**: Do not include any titles, introductions, conclusions, or irrelevant content. Output only the summary body.`,
 
  analysisKeyInfoPrompt: (targetLang: string) => 
    `Identify the 5-8 most important key moments, evenly distributed across the **entire video duration** (beginning, middle, end).\n\nFormat requirements:\n- One per line, format: [HH:MM:SS] Brief description (≤10 words)\n- **Must cover the entire video**, not just the beginning\n- Select truly important turning points, core ideas, or key conclusions\n- **Extremely concise**: Keep each description ≤10 words\n\nExample:\n[00:15] Introduction to topic\n[05:30] Core concept explained\n[15:45] Case study analysis\n[22:10] Summary of key points\n\nLanguage: ${targetLang}. **Forbidden**: No titles, explanations, or extra text.`,
  analysisTopicsPrompt: (targetLang: string) => 
    `Identify the 3-5 most important core topics, covering the entire video content.\n\nRequirements:\n- Output only Markdown bullet list (- Topic name)\n- **Extremely concise**: Each topic 3-5 words\n- Sort by importance\n- **Forbidden**: No explanations, descriptions, or extra text\n\nLanguage: ${targetLang}.`,
  ...
  batchDeleteConfirmation: (count: number) => `Are you sure you want to delete ${count} selected video${count > 1 ? 's' : ''} and all associated data? This action cannot be undone.`,
